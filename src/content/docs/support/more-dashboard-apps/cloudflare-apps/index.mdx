...
Please note that after December 20, 2024, DataDome will be uninstalled from Cloudflare zone(s). We encourage all customers who have configured DataDome through Cloudflare Apps to instead [configure DataDome through the Cloudflare Worker installation](https://docs.datadome.co/docs/cloudflare-worker).
